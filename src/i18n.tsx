...
const FRENCH_TRANSLATIONS: Record<string, string> = {
    ...
    'Emoji animation uses an independent 5 FPS clock, so changing the scroll speed does not accelerate it.': 'L’animation des emojis utilise une horloge indépendante à 5 FPS : modifier la vitesse de défilement ne l’accélère pas.',
