...
const FRENCH_TRANSLATIONS: Record<string, string> = {
    ...
    'One decider stores every detected voice for each sampled instant; each voice uses one programmable speaker and all speakers share the same tick clock.': 'Un decider stocke toutes les voix détectées à chaque instant échantillonné ; chaque voix utilise un programmable speaker et tous les speakers partagent la même horloge de ticks.',
    ...
    'and never exceeds 30 FPS.': 'et ne dépasse jamais 30 FPS.',
    Text: 'Texte',
    'FFmpeg extracts up to four simultaneous pitches per left/right channel. Each voice gets its own native Factorio instrument and speaker; every speaker shares one tick clock. Factorio allows at most one new sample per tick: 1–60 notes/s; 4–8 is recommended.': 'FFmpeg extrait jusqu’à quatre hauteurs simultanées par canal gauche/droit. Chaque voix dispose de son propre instrument natif Factorio et de son propre speaker ; tous les speakers partagent la même horloge de ticks. Factorio autorise au maximum un nouvel échantillon par tick : 1 à 60 notes/s ; une valeur de 4 à 8 est recommandée.',
