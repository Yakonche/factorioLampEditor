...
- Activer **Textures du jeu** dans le header pour afficher les lamps, combinators, poles, roboports, speakers et display panels visibles avec les illustrations officielles lues directement dans l’installation locale de Factorio détectée. Les lamps allumées reçoivent une lueur colorée en temps réel ; les vues très larges et dézoomées conservent le rendu rapide par pixels jusqu’à ce que les sprites individuels deviennent utiles. Les installations Steam et autonomes sont détectées automatiquement, et la case ouvre un sélecteur du dossier du jeu si la détection échoue. Chaque asset manquant revient individuellement à l’aperçu vectoriel.
